...
from oqhazardlib.source.rupture import Rupture as HazardlibRupture
from nrmllib import models as nrml_models
...
def nrml_to_hazardlib(src, mesh_spacing, bin_width, area_src_disc):
    ...
    See :mod:`nrmllib.models` and :mod:`oqhazardlib.source`.

    :param src:
        :mod:`nrmllib.models` seismic source instance.
...
def _point_to_hazardlib(src, mesh_spacing, bin_width):
    ...
    :param src:
        :class:`nrmllib.models.PointSource` instance.
    :param float mesh_spacing:
        Rupture mesh spacing, in km.
    :param float bin_width:
        Truncated Gutenberg-Richter MFD (Magnitude Frequency Distribution) bin
...
def _simple_to_hazardlib(src, mesh_spacing, bin_width):
    ...
    :param src:
        :class:`nrmllib.models.SimpleFaultRuptureModel` instance.
    :param float mesh_spacing:
        Rupture mesh spacing, in km.
    :param float bin_width:
        Truncated Gutenberg-Richter MFD (Magnitude Frequency Distribution) bin
...
def _complex_to_hazardlib(src, mesh_spacing, bin_width):
    ...
    :param src:
        :class:`nrmllib.models.ComplexFaultRuptureModel` instance.
    :param float mesh_spacing:
        Rupture mesh spacing, in km.
    :param float bin_width:
        Truncated Gutenberg-Richter MFD (Magnitude Frequency Distribution) bin
...
def _mfd_to_hazardlib(src_mfd, bin_width):
    ...
    :param src_mfd:
        :class:`nrmllib.models.IncrementalMFD` or
        :class:`nrmllib.models.TGRMFD` instance.
    :param float bin_width:
...
def _source_type(src_model):
    """Given of the source types defined in :mod:`nrmllib.models`,
    get the `source_type` for a
    :class:`~oqengine.db.models.ParsedSource`.
    """
...
class SourceDBWriter(object):
    ...
    :meth:`oqhazardlib.source.base.SeismicSource.\
get_rupture_enclosing_polygon`.)

    :param inp:
        :class:`~oqengine.db.models.Input` object, the top-level
        container for the sources written to the database. Should have an
        `input_type` of 'source'.
    :param source_model:
        :class:`nrmllib.models.SourceModel` object, which is an
...
class RuptureDBWriter(object):
    ...
    :param rupture_model:
        :class:`nrmllib.models.SimpleFaultRuptureModel` object or
        :class:`nrmllib.models.ComplexFaultRuptureModel`
    """
    ...
    def serialize(self):
        ...
        reference to the `oqengine.db.models.Input` object.
        """
        src = self.rupture_model
        if isinstance(src, nrmllib.models.SimpleFaultRuptureModel):
            rupture_type = 'simple_fault'
        elif isinstance(src,
                        nrmllib.models.ComplexFaultRuptureModel):
