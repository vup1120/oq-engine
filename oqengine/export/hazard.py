...
from nrmllib import writers as nrml_writers

from oqengine import logs
from oqengine.db import models
from oqengine.export import core
...
def export(output_id, target_dir):
    ...
    :param int output_id:
        ID of a :class:`oqengine.db.models.Output`.
    ...
    :returns:
        ...
        `output_type` attribute of :class:`oqengine.db.models.Output`.)
    """
...
def _export_fn_map():
    ...
    arguments: a :class:`~oqengine.db.models.Output` object and a
    target
    dir (`str`).
...
def _get_end_branch_export_path(target_dir, result, ltp):
    ...
    :param result:
        :mod:`oqengine.db.models` result object `with a foreign key
        reference to :class:`~oqengine.db.models.LtRealization`. The
        ...
        * sa_period
        ...
        See :class:`~oqengine.db.models.HazardCurve` for an example.
    :param ltp:
        Instance of a :class:`~oqengine.input.logictree.\
LogicTreeProcessor`.
    """
...
def export_hazard_curves(output, target_dir):
    ...
    :param output:
        :class:`oqengine.db.models.Output` with an `output_type` of
        `hazard_curve`.
    :param str target_dir:
        Destination directory location for exported files.
...
def export_gmf_scenario(output, target_dir):
    ...
    :param output:
        :class:`oqengine.db.models.Output`
...
class _DisaggMatrix(object):
    ...
    packed. The :class:`nrmllib.hazard.writers.DisaggXMLWriter`
