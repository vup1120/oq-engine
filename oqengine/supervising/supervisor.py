...
from oqengine.db.models import OqJob, ErrorMsg, JobStats
from oqengine import supervising
...
def ignore_sigint():
    ...
    from :func:`oqengine.engine.run_job` for job parent process and
