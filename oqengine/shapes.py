...
(-118.25, 34.04)]
        ...
        :returns:
            :class:`oqengine.shapes.Region` instance
        """
    ...
    def from_simple(cls, top_left, bottom_right):
        ...
        :returns: :py:class:`oqengine.shapes.Region` instance
        """
    ...
    def lower_left_corner(self):
        ...
        :returns: :py:class:`oqengine.shapes.Site` instance
...
class Site(hazardlib_geo.Point):
    ...
    def __eq__(self, other):
        ...
        :type other: :py:class:`oqengine.shapes.Site`
        """
...
def multipoint_ewkt_from_coords(coords):
    ...
    :func:`oqengine.utils.round_float`
