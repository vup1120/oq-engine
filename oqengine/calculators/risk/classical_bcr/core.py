...
from oqengine.calculators.risk.classical import core as classical
from oqengine.utils import stats
from oqengine.utils import tasks
...
def classical_bcr(job_id, assets, hazard_getter_name, hazard,
    ...
    :param str hazard_getter_name: class name of a class defined in the
      :mod:`oqengine.calculators.risk.hazard_getters`
    ...
    :param output_containers: A dictionary mapping hazard Output ID to
      ...
      :class:`oqengine.db.models.BCRDistribution` output container
...
class ClassicalBCRRiskCalculator(classical.ClassicalRiskCalculator):
    ...
    def create_outputs(self, hazard_output):
        ...
        :class:`oqengine.db.models.BCRDistribution` instance and its
        :class:`oqengine.db.models.Output` container.
