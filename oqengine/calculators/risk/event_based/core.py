...
from oqrisklib import api, scientific

from oqengine.calculators.risk import general
from oqengine.db import models
from oqengine.utils import tasks, stats
...
def event_based(job_id, assets, hazard_getter_name, hazard,
    ...
    :param job_id: the id of the current
        :class:`oqengine.db.models.OqJob`
    :param assets: the list of `:class:oqrisklib.scientific.Asset`
    instances considered
    :param str hazard_getter_name: class name of a class defined in the
      :mod:`oqengine.calculators.risk.hazard_getters` to be
      instantiated to
    ...
    :param dict output_containers: a dictionary mapping hazard Output
      ...
      :class:`oqengine.db.models.LossCurve` output container used to
      store the computed loss curves; b is the dictionary poe->ID of
      the :class:`oqengine.db.models.LossMap` output container used
      to store the computed loss maps; c is the same as a but for
      insured losses; d is the ID of the
      :class:`oqengine.db.models.AggregateLossCurve` output container
...
class EventBasedRiskCalculator(general.BaseRiskCalculator):
    ...
    def hazard_output(self, output):
        ...
        :class:`oqengine.db.models.GmfCollection` object that stores
    ...
    def hazard_outputs(self, hazard_calculation):
        """
        :returns: a list of :class:`oqengine.db.models.Output` hazard
