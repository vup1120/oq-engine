...
from oqrisklib.models.input import FragilityModel, FragilityFunctionSeq
...
def scenario_damage(job_id, assets, hazard_getter, hazard,
    ...
    :class:`oqrisklib.models.input.FragilityModel object
    :param fragility_functions: a
    :class:`oqrisklib.models.input.FragilityFunctionSeq object
