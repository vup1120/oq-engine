...
def classical(job_id, assets, hazard_getter_name, hazard,
    ...
    :param assets:
      iterator over :class:`oqengine.db.models.ExposureData` to take
      into account
    ...
    :param dict output_containers: A dictionary mapping hazard
      ...
      of the :class:`oqengine.db.models.LossMap` used to store
      the loss maps
...
class ClassicalRiskCalculator(general.BaseRiskCalculator):
    ...
    def hazard_output(self, output):
        ...
        :class:`oqengine.db.models.HazardCurve` object that stores
    ...
    def hazard_outputs(self, hazard_calculation):
        """
        :returns: a list of :class:`oqengine.db.models.HazardCurve`
