...
def hazard_curves_to_hazard_map(job_id, hazard_curve_id, poes):
    ...
    :param int job_id:
        ID of the current :class:`oqengine.db.models.OqJob`.
    :param int hazard_curve_id:
        ID of a set of
        :class:`hazard curves <oqengine.db.models.HazardCurve>`.
    :param list poes:
...
def do_hazard_map_post_process(job):
    ...
    :param job:
        A :class:`oqengine.db.models.OqJob` which has some hazard
