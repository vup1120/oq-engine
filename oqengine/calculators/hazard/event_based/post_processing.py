...
from oqengine.utils.general import block_splitter
...
def gmf_post_process_arg_gen(job):
    ...
    * SA damping
    ...
    As a side effect, :class:`oqengine.db.models.HazardCurve`
    records are
    created for each :class:`oqengine.db.models.LtRealization` and IMT.
...
def gmf_to_hazard_curve_task(job_id, point, lt_rlz_id, imt, imls, hc_coll_id,
    ...
    :param int job_id:
        ID of a currently running :class:`oqengine.db.models.OqJob`.
    :param point:
        A :class:`oqhazardlib.geo.point.Point` instance.
    :param int lt_rlz_id:
        ID of a :class:`oqengine.db.models.LtRealization` for the
        current calculation.
    :param str imt:
    ...
    :param int hc_coll_id:
        ID of a :class:`oqengine.db.models.HazardCurve`, which will be
...
def do_post_process(job):
    ...
    :param job:
        A :class:`oqengine.db.models.OqJob` instance.
    """
