...
from nrmllib.hazard.parsers import RuptureModelParser

# HAZARDLIB
from oqhazardlib.calc import ground_motion_fields
import oqhazardlib.gsim

from oqengine.calculators.hazard import general as haz_general
from oqengine.calculators import base
from oqengine import utils, logs
...
AVAILABLE_GSIMS = oqhazardlib.gsim.get_available_gsims()
...
def save_gmf(output_id, gmf_dict, points_to_compute, result_grp_ordinal):
    ...
    :param points_to_compute:
        An :class:`oqhazardlib.geo.mesh.Mesh` object, representing
...
class ScenarioHazardCalculator(haz_general.BaseHazardCalculatorNext):
    ...
    def initialize_sources(self):
        ...
        :class:`oqengine.db.models.ParsedRupture``) in pickle format.
        """
