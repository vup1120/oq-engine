...
from oqengine.calculators.hazard.classical.core import (
    ClassicalHazardCalculator)
from oqengine.calculators.hazard.event_based.core_next import (
    EventBasedHazardCalculator)
from oqengine.calculators.hazard.disagg.core import (
