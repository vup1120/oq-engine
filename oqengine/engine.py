...
from oqengine.db import fields
from oqengine.db.models import ExposureData
from oqengine.db.models import Input
from oqengine.db.models import Input2job
from oqengine.db.models import inputs4job
from oqengine.db.models import Job2profile
from oqengine.db.models import JobStats
from oqengine.db.models import ModelContent
from oqengine.db.models import OqJob
from oqengine.db.models import OqJobProfile
from oqengine.db.models import OqUser
from oqengine.db.models import profile4job
from oqengine.db.models import Src2ltsrc
from oqengine import kvs
from oqengine import logs
from oqengine import shapes
from oqengine.job import config as jobconf
from oqengine.job.params import ARRAY_RE
from oqengine.job.params import CALCULATION_MODE
from oqengine.job.params import INPUT_FILE_TYPES
from oqengine.job.params import PARAMS
from oqengine.kvs import mark_job_as_current
...
class JobContext(object):
    ...
    def __init__(self, params, job_id, sections=list(), base_path=None,
        ...
        :param oq_job_profile:
            :class:`oqengine.db.models.OqJobProfile` instance; database
            representation of the job profile / calculation configuration.
        :param oq_job:
            :class:`oqengine.db.models.OqJob` instance; database
...
def read_sites_from_exposure(job_ctxt):
    ...
    :returns:
        `list` of :class:`oqengine.shapes.Site` objects, with no
        duplicates
    """
...
def _identical_input(input_type, digest, owner_id):
    ...
    :returns: an `:class:oqengine.db.models.Input` instance or `None`
    """
    q = """
...
def _insert_input_files(params, job, force_inputs):
    ...
    :param job: The :class:`oqengine.db.models.OqJob` instance to use
...
def _prepare_job(params, sections, owner_username, job, force_inputs):
    ...
    :param job:
        The :class:`oqengine.db.models.OqJob` instance to use
    :param bool force_inputs: If `True` the model input files will be parsed
        and the resulting content written to the database no matter what.

    :returns:
        A new :class:`oqengine.db.models.OqJobProfile` object.
    """
