...
from oqengine.supervising import supervisor
...
def prepare_job(user_name="openquake", log_level='progress'):
    ...
    :returns:
        :class:`oqengine.db.models.OqJob` instance.
    """
...
def parse_config(source, force_inputs=False):
    ...
    :returns:
        ...
        and a `dict` of :class:`~oqengine.db.models.Input` objects,
...
def get_input(path, input_type, owner, force_input, name=None):
    """
    Get an :class:`~oqengine.db.models.Input` object for the given
    file (``path``).
    ...
    :param str input_type:
        The type of input. See :class:`oqengine.db.models.Input` for
        a list of valid types.
    :param owner:
        The :class:`~oqengine.db.models.OqUser` who will own the input,
    ...
    :returns:
        :class:`oqengine.db.models.Input` object to represent the
        input. As a side effect, this function will also store a full raw copy
        of the input file
        (see :class:`oqengine.db.models.ModelContent`)
...
def _identical_input(input_type, digest, owner):
    ...
    :param str digest:
        md5sum digest
    :param owner:
        the `:class:oqengine.db.models.OqUser` instance of the owner
    :returns:
        an `:class:oqengine.db.models.Input` instance or `None`
    """
...
def create_hazard_calculation(owner, params, files):
    ...
    :param owner:
        The :class:`~oqengine.db.models.OqUser` who will own this
        profile.
    :param dict params:
        Dictionary of parameter names and values. Parameter names should match
        exactly the field names of
        :class:`oqengine.db.model.HazardCalculation`.
    :param list files:
        List of :class:`~oqengine.db.models.Input` objects to be
        linked to the calculation.
    :returns:
        :class:`oqengine.db.model.HazardCalculation` object.
...
def create_risk_calculation(owner, params, files):
    """Given a params `dict` parsed from the config file, create a
    :class:`~oqengine.db.models.RiskCalculation`.
    ...
    :param dict params:
        Dictionary of parameter names and values. Parameter names should match
        exactly the field names of
        :class:`oqengine.db.model.RiskCalculation`.
    :param list files:
        List of :class:`~oqengine.db.models.Input` objects to be
        linked to the calculation.
    :returns:
        :class:`oqengine.db.model.RiskCalculation` object.
        A corresponding record will obviously be saved to the database.
    """
    if "export_dir" in params:
        params["export_dir"] = os.path.abspath(params["export_dir"])
...
def run_hazard(job, log_level, log_file, exports):
    ...
    :param job:
        :class:`oqengine.db.model.OqJob` instance which references a
        valid :class:`oqengine.db.models.HazardCalculation`.
    :param str log_level:
    ...
    :param list exports:
        ...
        supported.
    """
    from oqengine.calculators.hazard import CALCULATORS_NEXT
...
def run_risk(job, log_level, log_file, exports):
    ...
    :param job:
        :class:`oqengine.db.model.OqJob` instance which references a
        valid :class:`oqengine.db.models.RiskCalculation`.
    :param str log_level:
        The desired logging level. Valid choices are 'debug', 'info',
        'progress', 'warn', 'error', and 'critical'.
    :param str log_file:
    ...
    from oqengine.calculators.risk import CALCULATORS
...
def _run_calc(job, log_level, log_file, exports, calc, job_type):
    ...
    :param job:
        :class:`oqengine.db.model.OqJob` instance which references a
        valid :class:`oqengine.db.models.RiskCalculation` or
        :class:`oqengine.db.models.HazardCalculation`.
    :param str log_level:
        The desired logging level. Valid choices are 'debug', 'info',
        'progress', 'warn', 'error', and 'critical'.
    ...
    :param calc:
        ...
        :class:`oqengine.calculators.base.CalculatorNext`.
    :param str job_type:
        'hazard' or 'risk'
    """
...
def _switch_to_job_phase(job, ctype, status):
    ...
    :param job:
        An :class:`~oqengine.db.models.OqJob` instance.
    ...
    if status == "executing" and not oqengine.no_distribute():
