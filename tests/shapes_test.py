...
from oqengine.utils import round_float
...
class ShapesTestCase(unittest.TestCase):
    ...
    def test_round_float(self):
        ...
        :py:function:`oqengine.utils.round_float` function.
    ...
    def test_round_float_rounding(self):
        ...
        :py:function:`oqengine.utils.round_float` is unaffected context
        changes.
        """
    ...
    def test_simple_region_uses_round_floats(self):
        ...
        instances of :py:class:`oqengine.shapes.Region`.

        The region will be created using the
        :py:method:`oqengine.shapes.Region.from_simple` method.
        """
    ...
    def test_complex_region_uses_round_floats(self):
        """
        This test ensures the coordinate precision is properly limited for
        instance of :py:class:`oqengine.shapes.Region`.

        The region will be created using the
        :py:method:`oqengine.shapes.Region.from_coordinates` method.
        """
        # triangle
        input_coord_pairs = [
...
class SiteTestCase(unittest.TestCase):
    """
    Tests for the :py:class:`oqengine.shapes.Site` class.
    """
    ...
    def test_site_uses_round_floats(self):
        """
        This test ensures the coordinate precision is properly limited for
        instances of :py:class:`oqengine.shapes.Site`.
        """
        lon = -121.00000004
        lat = 29.00000006
...
class ShapesUtilsTestCase(unittest.TestCase):
    ...
    def test_multipoint_ewkt(self):
        ...
        :py:function:`oqengine.shapes.multipoint_ewkt_from_coords`
        '''
        expected_ewkt = \
    ...
    def test_polygon_ewkt(self):
        '''
        Test typical usage of
        :py:function:`oqengine.shapes.polygon_ewkt_from_coords`
        '''
    ...
    def test_polygon_ewkt_round_float(self):
        '''
        Test usage of
        :py:function:`oqengine.shapes.polygon_ewkt_from_coords` to
