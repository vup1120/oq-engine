...
from oqengine.calculators.hazard.classical import core
...
class ClassicalHazardCalculatorTestCase(unittest.TestCase):
    ...
    def test_pre_execute(self):
        ...
        base_path = ('oqengine.calculators.hazard.classical.core'
    ...
    def test_initialize_site_model_no_site_model(self):
        patch_path = 'oqengine.calculators.hazard.general.\
store_site_model'
