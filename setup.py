...
PY_MODULES = ['oqengine.bin.cache_gc', 'oqengine.bin.oqscript']

setup(
    entry_points={
        "console_scripts": [
            "openquake = oqengine.bin.oqscript:main",
            "oq_cache_gc = oqengine.bin.cache_gc:main",
            "oq_monitor = oqengine.bin.openquake_supervisor:main",
            ]},
    name="oqengine",
    version=version,
